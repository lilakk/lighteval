...
extend_enum(Metrics, "f1_score_hotpotqa", f1_score_hotpotqa)
extend_enum(Metrics, "entailment_fuzzy_hotpotqa", entailment_fuzzy_hotpotqa)
extend_enum(Metrics, "entailment_fuzzy_hotpotqa_v2", entailment_fuzzy_hotpotqa_v2)
extend_enum(Metrics, "entailment_exact_hotpotqa", entailment_exact_hotpotqa)
